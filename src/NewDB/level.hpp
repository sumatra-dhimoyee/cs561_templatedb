...
namespace templatedb
{
    ...
    class Level
    {
        ...
        bool add_sst(SST<K,V> sst, bool leveled, std::vector<zone<K>>& fp, BF::BloomFilter& bf, u_int8_t no_levels);
        SST<K,V> merge_runs(std::vector<zone<K>>& fp,  BF::BloomFilter& bf, u_int8_t no_levels);
        void clear();
